...
export class Ec2CdkStack extends cdk.Stack {
  ...
  const pipeline = new Pipeline(this, 'python_web_pipeline',{
    ...
    const githubSourceAction = new GitHubSourceAction({
      ...
      owner: 'Vinit-Technman', // THIS NEEDS TO BE CHANGED TO YOUR OWN USER ID
      repo: 'AWS-Bootstrapping-an-Amazon-EC2-Instance-Using-User-data-to-Run-a-Python-Web-App',
      branch: 'master',
      output: sourceOutput,
    });
